...
import com.bekhamdev.newsy.main.domain.useCase.favourite.GetAllFavoriteCategoriesUseCase
import com.bekhamdev.newsy.main.domain.useCase.favourite.GetFavoriteArticlesByCategoryUseCase
...
data class FavoriteUseCases @Inject constructor(
    ...
    val getAllFavoriteCategoriesUseCase: GetAllFavoriteCategoriesUseCase,
    val getFavoriteArticlesByCategoryUseCase: GetFavoriteArticlesByCategoryUseCase
)
